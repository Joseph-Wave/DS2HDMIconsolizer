...
# WNS	TNS
# -3.3	-216.8	mix pin
# -3.1	-184.1	row pin + 2 pin in block 34, FINAL
# -3.2	-229.5	new, Looks like distribute all pins in minimal/same blocks saturate the blocks, 
#				but I cannot find the optimal point without checking every config, need to reed more documentation
...
## GPIO Pins
# ['GSP' 'GCK' 'DCLK' 'SPL' 'LS'] -> [4:0]

set_property -dict { PACKAGE_PIN P1    IOSTANDARD LVCMOS33 } [get_ports { pin_control[0] }]; #IO_L19N_T3_VREF_35 Sch=pio[23]	BANK 35
set_property -dict { PACKAGE_PIN N2    IOSTANDARD LVCMOS33 } [get_ports { pin_control[1] }]; #IO_L10P_T1_AD15P_35 Sch=pio[22]	BANK 35
set_property -dict { PACKAGE_PIN N1    IOSTANDARD LVCMOS33 } [get_ports { pin_control[2] }]; #IO_L10N_T1_AD15N_35 Sch=pio[21]	BANK 35
set_property -dict { PACKAGE_PIN M2    IOSTANDARD LVCMOS33 } [get_ports { pin_control[3] }]; #IO_L9P_T1_DQS_AD7P_35 Sch=pio[20]	BANK 35
set_property -dict { PACKAGE_PIN P3    IOSTANDARD LVCMOS33 } [get_ports { pin_control[4] }]; #IO_L12N_T1_MRCC_35 Sch=pio[19]	BANK 35

# blue = pin_RGB[5:0], green = pin_RGB[11:6], red = pin_RGB[17:12], Alphas pins: 0, 6, 12
# Blue
set_property -dict { PACKAGE_PIN M3    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[0] }]; #IO_L8N_T1_AD14N_35 Sch=pio[01]		BANK 35
set_property -dict { PACKAGE_PIN L3    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[1] }]; #IO_L8P_T1_AD14P_35 Sch=pio[02]		BANK 35
set_property -dict { PACKAGE_PIN A16   IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[2] }]; #IO_L12P_T1_MRCC_16 Sch=pio[03]		BANK 16
set_property -dict { PACKAGE_PIN K3    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[3] }]; #IO_L7N_T1_AD6N_35 Sch=pio[04]			BANK 35
set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[4] }]; #IO_L11P_T1_SRCC_16 Sch=pio[05]		BANK 16
set_property -dict { PACKAGE_PIN H1    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[5] }]; #IO_L3P_T0_DQS_AD5P_35 Sch=pio[06]		BANK 35
# Green
set_property -dict { PACKAGE_PIN A15   IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[6] }]; #IO_L6N_T0_VREF_16 Sch=pio[07]			BANK 16
set_property -dict { PACKAGE_PIN B15   IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[7] }]; #IO_L11N_T1_SRCC_16 Sch=pio[08]		BANK 16
set_property -dict { PACKAGE_PIN A14   IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[8] }]; #IO_L6P_T0_16 Sch=pio[09]				BANK 16
set_property -dict { PACKAGE_PIN J3    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[9] }]; #IO_L7P_T1_AD6P_35 Sch=pio[10]			BANK 35
set_property -dict { PACKAGE_PIN J1    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[10] }]; #IO_L3N_T0_DQS_AD5N_35 Sch=pio[11]	BANK 35
set_property -dict { PACKAGE_PIN K2    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[11] }]; #IO_L5P_T0_AD13P_35 Sch=pio[12]		BANK 35
# Red
set_property -dict { PACKAGE_PIN L1    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[12] }]; #IO_L6N_T0_VREF_35 Sch=pio[13]		BANK 35
set_property -dict { PACKAGE_PIN L2    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[13] }]; #IO_L5N_T0_AD13N_35 Sch=pio[14]		BANK 35
set_property -dict { PACKAGE_PIN U7    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[14] }]; #IO_L19P_T3_34 Sch=pio[45]			BANK 34*
set_property -dict { PACKAGE_PIN W7    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[15] }]; #IO_L13P_T2_MRCC_34 Sch=pio[46]		BANK 34*
set_property -dict { PACKAGE_PIN M1    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[16] }]; #IO_L9N_T1_DQS_AD7N_35 Sch=pio[17]	BANK 35
set_property -dict { PACKAGE_PIN N3    IOSTANDARD LVCMOS33 } [get_ports { pin_RGB[17] }]; #IO_L12P_T1_MRCC_35 Sch=pio[18]		BANK 35
